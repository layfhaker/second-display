...
& cmd /c "call `"$vcvars`" >nul && ml64 /nologo /c /Fo`"$obj`" `"$asmSrc`" && link /nologo /SUBSYSTEM:CONSOLE /ENTRY:mainCRTStartup /OUT:`"$exe`" `"$obj`" kernel32.lib ws2_32.lib ole32.lib dxgi.lib d3d11.lib mfplat.lib"
